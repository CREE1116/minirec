...
class AspireDiag(BaseModel):
    """Ablation: ASPIRE logic using only Diagonal (d_i) instead of SNR."""
    ...
    def fit(self, data_loader):
        print(f"Fitting AspireDiag (EASE-style, d_i scaling), lambda={self.reg_lambda}, alpha={self.alpha})")
